        ...
        <div className='container'>
            ...
            <div className='grid xl:grid-cols-3 gap-10 items-center'>
              <div className='col-span-2'>
                <div className='text-2xl mb-2 font-semibold text-center xl:text-start'>Hola! soy <span className='bg-secondary inline-block px-3'>Yustik</span></div>                  
              ...
              <div className='col-span-2 xl:col-span-1 text-center font-semibold'>
                  <div className='mx-auto rounded-full w-[120px] h-[120px] bg-secondary flex items-center justify-center mb-6'>
                    <span className='text-9xl text-center'>+10</span>
                  </div>
                  <div className='text-2xl'>años de experiencia</div>
              </div>
            </div>
