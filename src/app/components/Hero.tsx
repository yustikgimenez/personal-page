...
const Hero = () => {
  return (
    <section id="home" className=' h-full bg-primary min-h-screen items-center flex'>
        <div className='container'>   
            ...
            <div className='flex'>
                <div className='mx-auto'>
                    <Link href="#projects" className='text-sm sm:text-md bg-gray-950 hover:bg-gray-600 text-white p-4 xl:px-10 shadow-md uppercase transition-colors duration-400 mr-5 inline-block'>
                        Mis trabajos
                    </Link>
